...
if (mysqli_connect_errno()) {
	...
	$final_encryption = "vmbtrvw" . "$encryption1" . "$encryption2" . "**#3738s**A";
				...
				$mysqli->query("CREATE TABLE IF NOT EXISTS `setting` (
				  ...
				  `welcome_login` varchar(300) NOT NULL DEFAULT 'Welcome to Fuochat.',
...
?>';
					...
					$mysqli->query("INSERT INTO `setting` (title, default_theme) VALUES ('Fuochat', 'Gray')") or die($mysqli->error);
